		...
		<form method="post" action="">
			<table border="0" cellpadding="5" cellspacing="5" class="design">
				...
				<tr>
					...
					<td><input type="text" required="required" name="email" class="fields" size="15" placeholder="Enter Email ID" /></td>
				</tr>
				<tr>
					<td class="labels">password :</td>
					<td><input type="password" required="required" name="pass" class="fields" size="15" placeholder="Enter Password" /></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><input type="submit" value="Login" class="fields1" /></td>
				</tr>
			</table>
		</form>
		<br />
